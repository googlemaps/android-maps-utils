      ...
      getMap()
          .addPolygon(
              new PolygonOptions()
                  .add(
                      new LatLng(
                          builder.build().southwest.latitude, builder.build().southwest.longitude),
                      new LatLng(
                          builder.build().northeast.latitude, builder.build().southwest.longitude),
                      new LatLng(
                          builder.build().northeast.latitude, builder.build().northeast.longitude),
                      new LatLng(
                          builder.build().southwest.latitude,
                          builder.build().northeast.longitude)));
    } catch (Exception e) {
