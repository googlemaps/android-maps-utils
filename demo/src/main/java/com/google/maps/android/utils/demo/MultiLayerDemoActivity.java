...
/**
 * Activity that adds multiple layers on the same map. This helps ensure that layers don't interfere
 * with one another.
 */
public class MultiLayerDemoActivity extends BaseDemoActivity {
  public static final String TAG = "MultiDemo";
  ...
  protected void startDemo(boolean isRestore) {
    ...
    try {
      ...
      // GeoJSON polygon
      GeoJsonLayer geoJsonPolygonLayer =
          new GeoJsonLayer(
              getMap(),
    ...
    try {
      ...
      kmlPolylineLayer.setOnFeatureClickListener(
          feature ->
              Toast.makeText(
                      MultiLayerDemoActivity.this,
      ...
      kmlPolygonLayer.setOnFeatureClickListener(
          feature ->
              Toast.makeText(
                      MultiLayerDemoActivity.this,
