...
class KmlMapperTest {
    ...
    fun `test KmlPolygon to Scene`() {
        ...
        assertEquals(
            listOf(
                Point(lat = 1.0, lng = 2.0, alt = null),
                Point(lat = 3.0, lng = 4.0, alt = null),
                Point(lat = 5.0, lng = 6.0, alt = null),
                Point(lat = 1.0, lng = 2.0, alt = null),
            ),
    ...
    fun `test KmlPolygon with hole to Scene`() {
        ...
        assertEquals(
            listOf(
                Point(lat = 0.0, lng = 0.0, alt = 0.0),
                Point(lat = 0.0, lng = 10.0, alt = 0.0),
                Point(lat = 10.0, lng = 10.0, alt = 0.0),
                Point(lat = 10.0, lng = 0.0, alt = 0.0),
                Point(lat = 0.0, lng = 0.0, alt = 0.0),
            ),
            geometry.outerBoundary,
        )
        ...
        assertEquals(
            listOf(
                Point(lat = 2.0, lng = 2.0, alt = 0.0),
                Point(lat = 2.0, lng = 8.0, alt = 0.0),
                Point(lat = 8.0, lng = 8.0, alt = 0.0),
                Point(lat = 8.0, lng = 2.0, alt = 0.0),
                Point(lat = 2.0, lng = 2.0, alt = 0.0),
            ),
