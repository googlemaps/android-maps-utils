...
class MapViewRenderer(
    ...
    /**
     * Creates the [MarkerOptions] for legacy markers.
     *
     * This function extracts standard metadata (e.g. 'title' or 'name' for the marker's title,
     * and 'description' or 'snippet' for its snippet) from the feature's properties. This ensures
     * that the rendered markers are fully interactive and display information on-click.
     */
    ...
    /**
     * Creates the [AdvancedMarkerOptions] for modern markers.
     *
     * Similarly to legacy markers, we extract the title and snippet from the feature's properties
     * to populate the advanced marker's options so info windows show up when clicked.
     */
    private fun createAdvancedMarkerOptions(
        point: Point,
        style: PointStyle?,
        properties: Map<String, Any>,
    ...
    private fun createGroundOverlayOptions(
