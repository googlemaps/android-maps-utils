...
object KmlMapper {
    ...
    private fun addFolder(
        ...
        styleMaps: Map<String, KmlStyleMap>,
    ) {
...
private fun KmlPolygon.toRendererPolygon(): RendererPolygon {
    val outerBoundary =
        outerBoundaryIs.linearRing.coordinates.map {
            RendererPoint(
                lat = it.latitude,
                lng = it.longitude,
                alt = it.altitude,
