# Data Module: Unified Geospatial Renderer

The `data` module provides a unified, platform-agnostic architecture for parsing and rendering geospatial data (KML, GeoJSON, GPX) on Google Maps Android SDK.
