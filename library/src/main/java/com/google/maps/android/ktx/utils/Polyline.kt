...
public fun Polyline.contains(latLng: LatLng, tolerance: Double = 0.1): Boolean = this.canonicalContains(latLng, tolerance)
...
public val Polyline.sphericalPathLength: Double get() = this.canonicalSphericalPathLength
