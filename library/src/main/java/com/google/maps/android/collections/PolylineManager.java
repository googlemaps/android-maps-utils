 ...
 *
 * <p>All polyline operations (adds and removes) should occur via its collection class. That is,
 * don't add a polyline via a collection, then remove it via Polyline.remove()
 */
public class PolylineManager extends MapObjectManager<Polyline, PolylineManager.Collection>
