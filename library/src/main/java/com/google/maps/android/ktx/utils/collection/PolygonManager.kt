...
import com.google.maps.android.collections.addPolygon as canonicalAddPolygon
...
public inline fun PolygonManager.Collection.addPolygon(optionsActions: PolygonOptions.() -> Unit): Polygon = this.canonicalAddPolygon(optionsActions)
