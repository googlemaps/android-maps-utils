...
import com.google.maps.android.collections.addCircle as canonicalAddCircle
...
public inline fun CircleManager.Collection.addCircle(optionsActions: CircleOptions.() -> Unit): Circle = this.canonicalAddCircle(optionsActions)
