...
public operator fun LatLng.component1(): Double = this.canonicalComponent1()

@Deprecated("Moved to com.google.maps.android.component2", ReplaceWith("component2()", "com.google.maps.android.component2"))
public operator fun LatLng.component2(): Double = this.canonicalComponent2()
...
public fun List<LatLng>.isLocationOnPath(latLng: LatLng, geodesic: Boolean, tolerance: Double = 0.1): Boolean = this.canonicalIsLocationOnPath(latLng, geodesic, tolerance)
...
public fun List<LatLng>.isOnEdge(latLng: LatLng, geodesic: Boolean, tolerance: Double = 0.1): Boolean = this.canonicalIsOnEdge(latLng, geodesic, tolerance)
...
public fun List<LatLng>.containsLocation(latLng: LatLng, geodesic: Boolean): Boolean = this.canonicalContainsLocation(latLng, geodesic)

@Deprecated("Moved to com.google.maps.android.simplify", ReplaceWith("simplify(tolerance)", "com.google.maps.android.simplify"))
public fun List<LatLng>.simplify(tolerance: Double): List<LatLng> = this.canonicalSimplify(tolerance)

@Deprecated("Moved to com.google.maps.android.toLatLngList", ReplaceWith("toLatLngList()", "com.google.maps.android.toLatLngList"))
public fun String.toLatLngList(): List<LatLng> = this.canonicalToLatLngList()
...
public fun List<LatLng>.latLngListEncode(): String = this.canonicalLatLngListEncode()
...
public fun List<LatLng>.isClosedPolygon(): Boolean = this.canonicalIsClosedPolygon()
...
public fun List<LatLng>.sphericalPathLength(): Double = this.canonicalSphericalPathLength()
...
public fun List<LatLng>.sphericalPolygonArea(): Double = this.canonicalSphericalPolygonArea()
...
public fun List<LatLng>.sphericalPolygonSignedArea(): Double = this.canonicalSphericalPolygonSignedArea()
...
public fun LatLng.sphericalHeading(toLatLng: LatLng): Double = this.canonicalSphericalHeading(toLatLng)
...
public fun LatLng.withSphericalOffset(distance: Double, heading: Double): LatLng = this.canonicalWithSphericalOffset(distance, heading)
...
public fun LatLng.computeSphericalOffsetOrigin(distance: Double, heading: Double): LatLng? = this.canonicalComputeSphericalOffsetOrigin(distance, heading)
...
public fun LatLng.withSphericalLinearInterpolation(to: LatLng, fraction: Double): LatLng = this.canonicalWithSphericalLinearInterpolation(to, fraction)
...
public fun LatLng.sphericalDistance(to: LatLng): Double = this.canonicalSphericalDistance(to)
