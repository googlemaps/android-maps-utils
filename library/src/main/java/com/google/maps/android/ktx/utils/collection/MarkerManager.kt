...
import com.google.maps.android.collections.addMarker as canonicalAddMarker
...
public inline fun MarkerManager.Collection.addMarker(optionsActions: MarkerOptions.() -> Unit): Marker = this.canonicalAddMarker(optionsActions)
