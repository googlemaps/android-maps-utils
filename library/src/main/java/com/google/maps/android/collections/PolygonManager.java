 ...
 *
 * <p>All polygon operations (adds and removes) should occur via its collection class. That is,
 * don't add a polygon via a collection, then remove it via Polygon.remove()
 */
public class PolygonManager extends MapObjectManager<Polygon, PolygonManager.Collection>
