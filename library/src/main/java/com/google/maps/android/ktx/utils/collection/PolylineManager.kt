...
import com.google.maps.android.collections.addPolyline as canonicalAddPolyline
...
public inline fun PolylineManager.Collection.addPolyline(optionsActions: PolylineOptions.() -> Unit): Polyline = this.canonicalAddPolyline(optionsActions)
